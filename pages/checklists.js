...
function FormsTable({menuItems, formsItems}) {
    ...
    const URL = `https://api.acralending.com/api/corr-portal-program-checklists?pagination[page]=${pageNumber}&pagination[pageSize]=6&populate=*`;
                        ...
                        <div className="relative rounded-xl overflow-auto">
                            <table className="border-collapse table-auto w-full text-sm">
                                ...
                                <tr>
                                    ...
                                    {/* <th className="border-b dark:border-slate-600 font-medium p-4 pl-8 pt-0 pb-3 text-slate-500 dark:text-slate-400 text-left"></th> */}
                                    <th className="border-b dark:border-slate-600 font-medium p-4 pt-0 pb-3 text-slate-500 dark:text-slate-400 text-left">Download</th>
                                </tr>
                                </thead>
