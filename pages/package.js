        ...
        <div className="relative w-full">
            ...
            {isLoading ? (
                ...
                <div className="md:flex relative">
                    <SideBar props={menuItems} />
                    <div className="md:flex p-10 md:w-2/3 pt-18 justify-center m-auto">
                        <iframe className="md:w-8/12 w-full aspect-video min-h-[510px]" src="https://acralending.com/box-api/box-corr-loan-scenario.html?var=1"></iframe>
                    </div>
                </div>
            )}
            <Footer />
...
export default purchasePackageUpload;